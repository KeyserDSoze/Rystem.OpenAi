...
namespace Rystem.OpenAi.Assistant
{
    ...
    public interface IOpenAiFileSearchToolResourcesAssistant
    {
        IOpenAiAssistant Use();
        /// <summary>
        ...
        /// </param>
        /// <returns></returns>
        IOpenAiFileSearchToolResourcesAssistant WithStaticChunkingStrategy(int maxChunkSize, int chunkOverlap);
        /// <summary>
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        IOpenAiFileSearchToolResourcesAssistant AddMetadata(string key, string value);
        /// <summary>
        /// Set of 16 key-value pairs that can be attached to a vector store. This can be useful for storing additional information about the vector store in a structured format. Keys can be a maximum of 64 characters long and values can be a maximum of 512 characters long.
        /// </summary>
        /// <param name="metadata"></param>
        /// <returns></returns>
        IOpenAiFileSearchToolResourcesAssistant AddMetadata(Dictionary<string, string> metadata);
        /// <summary>
        /// Remove a metadata key.
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        IOpenAiFileSearchToolResourcesAssistant RemoveMetadata(string key);
        /// <summary>
        /// Clear all metadata.
        /// </summary>
        /// <returns></returns>
        IOpenAiFileSearchToolResourcesAssistant ClearMetadata();
    }
    public interface IOpenAiFileSearchAssistant
    {
        /// <summary>
        /// The ranking options for the file search. If not specified, the file search tool will use the auto ranker and a score_threshold of 0.
        /// </summary>
        /// <returns></returns>
        IOpenAiAssistant UseDefault();
        /// <summary>
        /// The ranking options for the file search. If not specified, the file search tool will use the auto ranker and a score_threshold of 0.
        /// </summary>
        ...
        /// <returns></returns>
        IOpenAiAssistant UseCustom(RankerName ranker, int scoreThreshold);
    }
